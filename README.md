...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jupyter-videochat-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11779&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jupyter-videochat-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jupyter-videochat` can be installed with:

```
conda install jupyter-videochat
```

It is possible to list all of the versions of `jupyter-videochat` available on your platform with:
